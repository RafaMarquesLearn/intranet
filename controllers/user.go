...
import (
	...
	"github.com/RafaMarquesLearn/intranet/models"
	pk "github.com/RafaMarquesLearn/intranet/utils/pbkdf2"
...
func sendVerification(email, u string) bool {
	...
	msg.SetAddressHeader("From", "sender-email@gmail.com", "intranet Corporation")
	msg.SetHeader("To", email)
	msg.SetHeader("Subject", "Account Verification for intranet Corporation")
	msg.SetBody("text/html", "To verify your account, please click on the link: <a href=\""+link+
		"\">"+link+"</a><br><br>Best Regards,<br>intranet Corporation")
	m := gomail.NewMailer(host, "sender-email@gmail.com", "sender-pass", port)
